...
public class ConfConcTest {
	...
	public PrimeEventStructure<Integer> getPES1() {
		...
		return PORuns2PES.getPrimeEventStructure(
				adj, conc, Arrays.asList(0), Arrays.asList(3), ImmutableMap.of(0, "a", 1, "b", 2, "c", 3, "d"), "PES1");
	}
	public PrimeEventStructure<Integer> getPES2() {
		...
		return PORuns2PES.getPrimeEventStructure(
				adj, conc, Arrays.asList(0), Arrays.asList(3,4), ImmutableMap.of(0, "a", 1, "b", 2, "c", 3, "d", 4, "d"), "PES2");
	}
}
